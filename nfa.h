 ...
 */
extern Set NFA_get_transitions(NFA nfa, Set setState, char sym);

/**
 * For the given NFA, add the state dst to the set of next states from
 * state src on input symbol sym.
 */
extern void NFA_add_transition(NFA nfa, int src, char sym, Set dst);
 ...
 */
extern void NFA_add_transition_all(NFA nfa, int src, Set dst);
 ...
 */
extern bool NFA_get_accepting(NFA nfa, Set setState);
